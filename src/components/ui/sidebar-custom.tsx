...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "h-screen px-4 py-6 hidden md:flex md:flex-col bg-[hsl(var(--bg-panel))] border-r border-[hsl(var(--border-subtle))] w-[280px] flex-shrink-0",
        className
      )}
      animate={{
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="text-sm font-medium group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0 ml-5"
      >
        {label}
      </motion.span>
    </button>
